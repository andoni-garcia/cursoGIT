<@hst.setBundle basename="Etools,ProductToolbar,CylinderConfigurator,ProductConfigurator,Eshop,AddToCartBar"/>
<#--${isAuthenticated?then('idbl_hto_wrapper--user_logged_in', '')}-->
<div class="idbl_hto_wrapper"  id="idbl_hto_wrapper">
    <div class="idbl_hto  idbl_hto--cc container">
        ...
        <div class="idbl_hto__content">
            <input disabled type="checkbox" name="cylinder-info-container__partnumber_switch" id="cylinder-info-container__partnumber_switch" class="" style="visibility: hidden">
            <section class="idbl_hto__content__data">
                <div id="" class="cylinder-info-container__configuration_details add-to-basket-bar-component" data-swiftype-index="false">
                    <h3 class="sscw__selection_table__title sub-title" style="color: #0074BE;font-weight: bold;">
...
<#--            <section class="idbl_hto__content__partnumber" id="hto_closed_text">-->
<#--                Check Reference, Prices & Lead Time-->
<#--            </section>-->
            <section class="idbl_hto__content__partnumber" id="hto_partnumbers" style="display: none">
                ...
                <strong class="idbl_hto__partnumber__code config" id="idbl_hto__partnumber__code"></strong>
<#--                <div class="idbl_hto__partnumber__code_wrapper" id="idbl_hto__partnumber__code_wrapper" data-partnumber-code="" >-->
...
<#--                        <!--------------------------------------------------------------------------------&ndash;&gt;-->
<#--                        <!------------------------------- PART NUMBER HTML -------------------------------&ndash;&gt;-->
<#--                        <!--------------------------------------------------------------------------------&ndash;&gt;-->

<#--                        <!--------------------------------------------------------------------------------&ndash;&gt;-->
<#--                        <!--------------------------- END PART NUMBER HTML -------------------------------&ndash;&gt;-->
<#--                        <!--------------------------------------------------------------------------------&ndash;&gt;-->
<#--                    </div>-->
<#--                </div>-->
...
<#--            <#else>-->
                <@addToBasketBar productId="158177" renderingMode="configurator" showQuantityBox=true showInfo=true showExtraInfo=true series = true  new_hto=true
                statisticsSource="PCP FREE CONFIGURATION" />
<#--            </#if>-->
            <section class="idbl_hto__content__actions idbl_hto__content__actions--switch">
                <div data-side="partnumber" class="cylinder-info-container__partnumber_toggler">
                    <span id="hto_viewDetailsLabel" style="white-space: nowrap;"><strong>Check Reference, Prices & Lead Time</strong></span>
                    <span id="hto_closeLabel" style="display: none">Close</span>
