...
<#if isSeriesPage?? && isSeriesPage == true>
    <#include "ssi/_ssi-series-detail-macro.ftl">
<#else>
    <#include "ssi/_ssi-detail-macro.ftl">
</#if>
<#include "ssi/ssi-page-component.ftl">
<#include "_selection-basket-favourites-bar-macro.ftl" />
<div class="ssi-component" id= ${ssiTabId}>
    <div id="ssi-filters-container" class="col-lg-12 p-2">
        <div class="row">
            <div class="col-lg-12 p-0">
                <div class="ssi-filter-text p-2">
                    <p><@fmt.message key="standardstockeditems.filter.description" /></p>
                    <p><@fmt.message key="standardstockeditems.filter.advice" /></p>
                </div>
                ...
                <div class="row p-2">
                    ...
                    <div class="col-2 col-lg-1 p-lg-0 p-md-2 ssi-filter-buttons mt-3 mb-2">
                        <a href="#" title="<@fmt.message key="standardstockeditems.filter.showmore" />"
                           class="ssi-filter-btn-show ssi-filter-btn-show-js float-right mr-2"> <i
                                    class="fas fa-plus-circle fa-2x blue"></i></a>
                        <a href="#" title="<@fmt.message key="standardstockeditems.filter.showless" />"
                ...
                <div class="row p-2">
                    <div class='col-12 p-6 p-md-2 part-number-filter-container'>
                        <input class="form-control" type="text" id="partNumberFilter"
                               placeholder="<@fmt.message key="standardstockeditems.filter.placeholder" />">
                        <button class="btn btn-secondary btn-secondary--blue-border
                        align-self-center ssi-filter-btn-all ssi-filter-btn-all-js ml-1"><@fmt.message key="standardstockeditems.filter.showall" /></button>
                    </div>
                </div>
            </div>
            <div class="w-100"></div>
    ...
    <div class="col-lg-12 p-2" id="ssi-container">
            ...
            <div class="row mt-4 mb-2 d-none d-lg-flex spares-accessories__header">
                <div class="col-3 col-lg-3 sub-title" id="referenceLbl">
                    <label for="selectAll_id" class="smc-checkbox">
                        <@selectionBasketFavouritesBar ssiProductComponentId='${ssiTabId}' selectAllCheckboxFeature=true statisticsSource="PCP SSI" seriesCheckBox="ssi" />
                    </label>
                </div>
                <div class="col-6 col-lg-4 column-titles__container">
                    <#list ssi_columns?split(",") as column>
                        <div class="sub-title sub-column" id="column_${column}"></div>
                    </#list>
                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="d-flex ssi-footer col-12  p-0"><@selectionBasketFavouritesBar ssiProductComponentId='${ssiTabId}' selectAllCheckboxFeature=!(isSeriesPage?? && isSeriesPage) statisticsSource="PCP SSI" /></div>
                </div>
