    ...
    <div class="cta-box-list">
        <#if document.primaryLink?? && document.primaryLink.linkCaption?length gt 0>
            <div class="cta-box">
                ...
                <a href="${primaryLink}" class="btn btn-primary mr-10 openModalBtn" <@osudio.openInNewTab primaryLink/>>${document.primaryLink.linkCaption?html}</a>
            </div>
        </#if>
        <#if document.secondaryLink?? && document.secondaryLink.linkCaption?length gt 0>
            <div class="cta-box">
                ...
                <a href="${secondaryLink}" class="btn btn-secondary btn-secondary--blue-border openModalBtn" <@osudio.openInNewTab secondaryLink/>>${document.secondaryLink.linkCaption?html}</a>
            </div>
        </#if>
