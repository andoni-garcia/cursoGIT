...
<#compress>
    <@hst.setBundle basename="intranet-catalogues.list,intranet-communication_images"/>
</#compress>
<#assign empty=true>
<#if document??>
    <#assign empty=false>
...
<div class="container generalList-container">
    ...
    <h2 class="heading-08 color-blue mt-20"><@fmt.message key="catalogue_detail.title"/></h2>
    ...
    <div class="col-md-9">
        ...
        <div class="row generalListFormRow">
            <div class="blue-separator">
                <div class="col-md-2 col-sm-2">
                    <label class="generalList-label generalList-white-label"><strong><@fmt.message key="catalogues.productseries"/></strong></label>
                </div>
                <div class="col-md-10 col-sm-10">
                    <span class="generalList-white-value">${document.productserie}</span>
                </div>
            </div>
        </div>
        ...
        <div class="row ssFormRow mt-4">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.cataloguenumber"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
                <span class="generalList-value">${document.catalogueid}</span>
            </div>
        </div>

        <div class="row ssFormRow mt-4">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.language"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
                <span class="generalList-value">${languageList[document.language]}</span>
            </div>
        </div>

        <div class="row generalListFormRow mt-3">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.index"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
        ...
        <div class="row ssFormRow mt-3">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.product"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
                <#if document.product?? && document.product>
                    <span class="generalList-value"><@fmt.message key="catalogues.yes"/></span>
                <#else>
                    <span class="generalList-value"><@fmt.message key="catalogues.no"/></span>
                </#if>
            </div>
        </div>
        ...
        <div class="row ssFormRow mt-3">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.createdby"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
        ...
        <div class="row ssFormRow mt-3">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.createdon"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
                <span class="generalList-value">${document.createdon.time?datetime?string["dd/MM/yyyy"]}</span>
            </div>
        </div>

        <div class="row ssFormRow mt-3">
            <div class="col-md-2 col-sm-12">
                <label class="generalList-label"><strong><@fmt.message key="catalogues.lastmodified"/></strong></label>
            </div>
            <div class="col-md-10 col-sm-12">
                <span class="generalList-value">${document.lastmodified.time?datetime?string["dd/MM/yyyy"]}</span>
            </div>
        </div>
        ...
        <#if !empty>
            ...
            <div class="row generalListFormRow mt-5">
                <div class="blue-separator">
                    <div class="col-md-2 col-sm-2">
                        <label class="generalList-label generalList-white-label"><strong><@fmt.message key="catalogues.attachments"/></strong></label>
                    </div>
                </div>
            </div>
                ...
                <div class="row mt-3">
                    <ul class="generalList-files-list">
                        <#if document.attachments.richFile[0].external.url?has_content>
                            <#assign fileurl = document.attachments.richFile[0].external.url>
                        ...
                        <#elseif document.attachments.richFile[0].embedded?has_content && !document.attachments.richFile[0].embedded.blank>
                            <#assign file = document.attachments.richFile[0].embedded>
                                <li class="generalList-files-list-item mt-4">
                                    <div class="attachment-detail">
