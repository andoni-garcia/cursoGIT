...
<#compress>
    <@hst.setBundle basename="intranet-catalogues.list"/>
</#compress>
                    ...
                    <#if facet.folders?? && facet.folders?has_content>
                        <label class="smc-select mr-2 w-auto-md-up">
                            <select class="facet-select">
                                <option class="first-option" value="">${facet.name}</option>
                                    ...
                                    <#if value.count &gt; 0>
                                        <#if value.leaf>
                                            ...
                                            <option class="remove-option" selected value="${removeLink}">
                                                <#if languageList[value.name]??>
                                                    ${languageList[value.name]} &nbsp;(${value.count})
                                                <#elseif indexList[value.name]??>
