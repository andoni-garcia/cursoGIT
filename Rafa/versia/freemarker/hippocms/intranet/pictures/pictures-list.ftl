...
<#compress>
    ...
    <@hst.setBundle basename="intranet-pictures,SearchPage"/>
</#compress>
...
<div class="container">
    <h2 class="heading-08 color-blue mt-20"><@fmt.message key="pictures_list.title"/></h2>
            ...
            <#if !empty>
                <div class="table-responsive-lg">
                    <table class="table">
                        <thead>
                        <tr>
                            <th scope="col"><@fmt.message key="pictures.index"/></th>
                            <th scope="col"><@fmt.message key="pictures.series"/></th>
                            <th scope="col"></th>
                        </tr>
                        </thead>
                        <tbody>
                        <@hst.link var="link" siteMapItemRefId="PIdetailId"/>
                        <#if pageable?? && pageable.items?has_content>
                            <#list pageable.items as item>
                                <tr>
                                    <td>${indexList[item.index]}</td>
                                    <td>${item.series}</td>
                                    <td><a href="${link}/${item.name}"><@fmt.message key="pictures.details"/></a></td>
                                </tr>
                            </#list>
                        </#if>
                        </tbody>
                ...
                <div class="dialog list-dialog">
                    <div class="dialog list-dialog-container">
                        ...
                        <div class="dialog-content">
                            <span class="dialog-title"><@fmt.message key="pictures.noresult"/></span>
                            <span><@fmt.message key="pictures.spelled"/></span>
                        </div>
                    </div>
                </div>
