...
<@hst.link var="picturesListMain" siteMapItemRefId="picturesmainlist" fullyQualified=true />
<@hst.link var="linkSearch"/>

    <form action="${linkSearch}" class="row">
        <div class="col-lg-8 col-sm-8 mb-3">
            <input class="form-control" type="search"
                   placeholder="<@fmt.message key="pictures.placeholder_search"/>"
                   name="query"
                   value="${queryParam}">
        ...
        <div class="col-lg-2 col-sm-4 mb-3 align-self-end">
            <button type="submit" class="btn btn-primary w-100">
                <span><@fmt.message key="pictures.button.search"/></span>
            </button>
        </div>
        <div class="col-lg-2 col-sm-4 mb-3 align-self-end">
                <a id="reset" href="${picturesListMain}"
                   class="btn btn-primary w-100">
                    <@fmt.message key="pictures.button.showall"/></a>
        </div>
    </form>
