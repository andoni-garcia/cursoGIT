...
<#compress>
    <@hst.setBundle basename="intranet-price_proposal"/>
</#compress>
                                    ...
                                    <#if value.count &gt; 0>
                                        <#if value.leaf>
                                            ...
                                            <option class="remove-option" selected value="${removeLink}">
                                                <#if categoryList[value.name]??>
                                                    ${categoryList[value.name]} &nbsp;(${value.count})
                                                <#elseif statusList[value.name]??>
                                                    ${statusList[value.name]} &nbsp;(${value.count})
                                                <#else>
