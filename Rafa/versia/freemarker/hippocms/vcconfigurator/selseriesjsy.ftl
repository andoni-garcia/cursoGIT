                        ...
                        <div class="simple-collapse__bodyInner p-0">
                            <div id="" class="container_12">
                                ...
                                <div class="row mb-3" style="display: none">
                                    <div class="col-12 h4 mt-4"><@fmt.message key="ManyfoldType"/> <a href="${s3bucket}valve-configurator/${.locale}/Manifold_Types.pdf" target="_blank"><i id="manifoldInfo" class="fas fa-info-circle"></i></a></div>

                                    <div class="col-6 col-md-4 col-lg-2">
                                        <div class="select-option active">
                                            
                                                <span id="m_ip67" class="manyfold selSeriesElement sprite ip67 active selected"></span>
                                ...
                                <div class="row mb-3" style="display: none">
                                    ...
                                    <div class="col-6 col-md-4 col-lg-2">
                                        <div class="select-option active">
                                                <span id="p_side" class="piping selSeriesElement sprite side active selected"></span>
                                ...
                                <div class="row mb-3">
                                    <div class="col-12 h4 mt-4">2. <@fmt.message key="solenoidValveSize"/> <a href="${s3bucket}valve-configurator/${.locale}/JSY_Optimum_actuation_size_chart_of_air_cylinder.pdf" target="_blank"><i id="valveInfo" class="fas fa-info-circle"></i></a></div>
                                    <!-- option -->
                                    <div class="col-6 col-md-4 col-lg-2">
                                        <div class="select-option noactive">
