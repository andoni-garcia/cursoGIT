...
<div class="container">
	<div id="selSeriesContainer" class="container_12">
		<div>
	                        ...
	                        <div class="simple-collapse__bodyInner p-0">
	                            <div class="container_12">
	                                ...
	                                <div class="row mb-3">
	                                    ...
	                                    <div class="col-12 h5 mt-4"><@fmt.message key="parallelConection"/> <a href="${s3bucket}valve-configurator/${.locale}/VQC_Connection_type_Parallel_wiring.pdf" target="_blank"> <i id="parallelConnectionInfo" class="fas fa-info-circle"></i></a></div>
	                                    <!-- option -->
	                                ...
	                                <div class="row mb-3">
	                                    <div class="col-12 h5 mt-4"><@fmt.message key="serialInterface"/> <a href="${s3bucket}valve-configurator/${.locale}/VQC_Connection_types_Serial_wiring.pdf" target="_blank"><i id="serialConnectionInfo" class="fas fa-info-circle"></i></a></div>
	                                    <!-- option -->
	                                    <div class="col-6 col-md-4 col-lg-2">
	                                        <div class="select-option active">
	                                ...
	                                <div class="row mb-3">
	                                    <div class="col-12 h4 mt-4">2. <@fmt.message key="solenoidValveSize"/> <a href="${s3bucket}valve-configurator/${.locale}/VQC_Valve_size.pdf" target="_blank"><i id="valveInfo" class="fas fa-info-circle"></i></a></div>
	                                    <!-- option -->
	                                    <div class="col-6 col-md-4 col-lg-2">
	                                    ...
	                                    <div class="col-6 col-md-4 col-lg-2">
	                                        <div class="select-option noactive">
	                                                <span id="v_5000" class="valve selSeriesElement sprite nvqc5000 noactive"></span>
...
<@hst.headContribution  category="scripts">
	<script src="<@hst.webfile path="/freemarker/versia/js-menu/vcconfigurator/selseries-nvqc.js"/>" type="text/javascript"></script>
</@hst.headContribution>

<@hst.headContribution  category="scripts">
	<script src="<@hst.webfile path="/freemarker/versia/js-menu/vcconfigurator/configure-selseries-nvqc-options-set.js"/>" type="text/javascript"></script>
</@hst.headContribution>

<@hst.headContribution  category="scripts">
<!-- ROLLBACK S3
	<link rel="stylesheet" href="<@hst.webfile  path="/freemarker/versia/css-menu/vcconfigurator/sel_series_nvqc.css"/>" type="text/css"></link>
-->
 	<link rel="stylesheet" href="${s3bucket}valve-configurator/style/seriesVQC/sel_series_nvqc.css" type="text/css"></link>
</@hst.headContribution>