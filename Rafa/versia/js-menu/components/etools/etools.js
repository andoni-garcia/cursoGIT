...
function loadSession() {
    var session = "frl04e5a1c2-d3a1-437b-8cganfmauvdeb5te5mjod";

    $("#ffrl3D").attr("src", "https://etoolstest.smc.at/config/frl3d/index.html?id=" + session + "&country=eu&language=en");
}
